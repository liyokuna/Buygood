...
<div class="container">
    <div class="row page-title-row">
		<div class="col-md-6">
			<h3>Administrateur <small>» Liste des commandes archivées sur BuyGood</small></h3>
		</div>
    </div>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-4 form-group">
			<a class="btn btn-defalut btn-link" href="/users/commandes" role="button"><span class="glyphicon glyphicon-menu-left"> Go back</a>
		</div>		
	</div>
</div>
